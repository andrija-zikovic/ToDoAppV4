...
const DropDownMenu = ({ setDropDownVisibility, dropDownPath }: IProps) => {
    return (
        <div className="inset-x-0 top-16 z-10 h-auto bg-gray-700 flex flex-col justify-center items-center gap-2 px-2 py-4 border-b-2 border-orange-200 text-3xl w-96">
